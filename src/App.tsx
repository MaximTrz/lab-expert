...
import BidPrint from './views/print-templates/Bid'
...
import ActPrint from './views/print-templates/Act'
import AccDocument from './views/print-templates/AccDocument'
import CommentsPrint from './views/print-templates/Comments'
