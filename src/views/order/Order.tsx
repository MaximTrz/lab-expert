              ...
              <CCol>
                ...
                >
                  <CButton
                    ...
                    onClick={(e) => {
                      const itemId = params.id
                      navigate(`/acc-documents/${itemId}/print`)
                    }}
              ...
              <CCol>
                ...
                >
                  ...
                  <CButton
                    ...
                    onClick={(e) => {
                      if (isView) {
                        const title = `Комментарии к заявке № ${data?.id}`
                        saveAsPDF('comments', title)
                      }
                    }}
                    disabled={!data?.comments?.length}
                  >
